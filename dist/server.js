...
const utils = __webpack_require__(/*! ./utils */ "./node_modules/co-body/lib/utils.js"); // Allowed whitespace is defined in RFC 7159
...
const debug = __webpack_require__(/*! debug */ "./node_modules/debug/src/index.js")('koa:application');
...
const proto = module.exports = {
  ...
  onerror(err) {
    ...
    this.type = 'text'; // ENOENT support

    if ('ENOENT' == err.code) err.status = 404; // default to 500

    if ('number' != typeof err.status || !statuses[err.status]) err.status = 500; // respond
...
module.exports = {
  ...
  set body(val) {
    ...
    const setType = !this.header['content-type']; // string
...
/***/ "./simple-webpack":
/*!*************************************************!*\
  !*** external {"commonjs2":"./simple-webpack"} ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("./simple-webpack");
...
const SimpleWebpack = __webpack_require__(/*! ./simple-webpack */ "./simple-webpack");
...
const {
  SimpleWebpack
} = __webpack_require__(/*! ./externals.js */ "./src/externals.js");

const router = __webpack_require__(/*! koa-router */ "./node_modules/koa-router/lib/router.js")();

const bodyParser = __webpack_require__(/*! koa-bodyparser */ "./node_modules/koa-bodyparser/index.js")();

const webpack = new SimpleWebpack();
const app = new Koa(); // webpack服务

router.post('/webpack', (ctx, next) => {
  const reqData = ctx.request.body;
  return webpack.compile({
    name: reqData.name,
    constextPath: reqData.constextPath,
